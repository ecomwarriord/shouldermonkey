...
export default function SalonPage() {
  ...
  return (
    <div style={{ background: C.bg }}>
      ...
      {/* ── Signature stat ── */}
      <section style={{ padding: 'clamp(5rem, 9vw, 8rem) 0 clamp(4rem, 8vw, 7rem)', background: C.text, overflow: 'hidden', position: 'relative', zIndex: 2, marginTop: '-80px', borderRadius: '28px 28px 0 0' }}>
