      ...
      <body suppressHydrationWarning>
        ...
        <Script id="meta-pixel" strategy="afterInteractive">
          {`
            ...
            fbq('init', '1969422564450426');
            fbq('track', 'PageView');
          `}
        </Script>
        <noscript>
          <img height="1" width="1" style={{ display: 'none' }}
            src="https://www.facebook.com/tr?id=1969422564450426&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {/* GHL Chat Widget */}
        <Script
          ...
          data-widget-id="69d388e8a3eb88a143774f5c"
          strategy="lazyOnload"
        />
      </body>
    </html>
